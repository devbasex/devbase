# /ndf:review 実行 (cross-review gemini / round 3)

PR #75 を **gemini の観点でレビューし、gh api で直接 PR に投稿** してください。
...
- review body の **先頭行** に必ず以下を入れる:
  ```
  ## 🤖 cross-review | round 3 | gemini | <event(intent)>
  ```
...
- 投稿後、サマリを **/var/folders/qz/qxt0p_y15xv5jg4x77zmtxj80000gp/T/ndf-worktrees/devbasex--devbase/pr75/.cross_review/gemini-review-pr75-result.json** に
  **必ず以下のキーで** 書く:
  ```json
  {
    "event": "APPROVE",
...
- payload は **/var/folders/qz/qxt0p_y15xv5jg4x77zmtxj80000gp/T/ndf-worktrees/devbasex--devbase/pr75/.cross_review/gemini-review-pr75-round3-payload.json** に保存
